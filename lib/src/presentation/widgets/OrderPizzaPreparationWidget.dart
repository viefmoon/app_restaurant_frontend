...
class OrderPizzaPreparationWidget extends StatefulWidget {
  ...
  @override
  _OrderPizzaPreparationWidgetState createState() =>
      _OrderPizzaPreparationWidgetState();
}

class _OrderPizzaPreparationWidgetState
  ...
  @override
  void didUpdateWidget(covariant OrderPizzaPreparationWidget oldWidget) {
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              _getColorByOrderState(widget.order.pizzaPreparationStatus),
