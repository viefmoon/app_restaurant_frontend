...
import 'package:app/src/data/dataSource/local/SharedPref.dart' as _i9;
...
import 'package:app/src/data/dataSource/remote/services/UsersService.dart'
    as _i11;
import 'package:app/src/di/AppModule.dart' as _i13;
import 'package:app/src/domain/repositories/AuthRepository.dart' as _i3;
import 'package:app/src/domain/repositories/RolesRepository.dart' as _i6;
import 'package:app/src/domain/repositories/UsersRepository.dart' as _i10;
import 'package:app/src/domain/useCases/auth/AuthUseCases.dart' as _i5;
import 'package:app/src/domain/useCases/roles/RolesUseCases.dart' as _i8;
import 'package:app/src/domain/useCases/users/UsersUseCases.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.RolesRepository>(() => appModule.rolesRepository);
    gh.factory<_i7.RolesService>(() => appModule.rolesService);
    gh.factory<_i8.RolesUseCases>(() => appModule.rolesUseCases);
    gh.factory<_i9.SharedPref>(() => appModule.sharedPref);
    gh.factoryAsync<String>(() => appModule.token);
    gh.factory<_i10.UsersRepository>(() => appModule.usersRepository);
    gh.factory<_i11.UsersService>(() => appModule.usersService);
