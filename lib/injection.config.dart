...
import 'package:app/src/data/dataSource/local/SharedPref.dart' as _i18;
...
import 'package:app/src/data/dataSource/remote/services/UsersService.dart'
    as _i20;
import 'package:app/src/di/AppModule.dart' as _i22;
...
import 'package:app/src/domain/repositories/OrdersRepository.dart' as _i12;
import 'package:app/src/domain/repositories/RolesRepository.dart' as _i15;
import 'package:app/src/domain/repositories/UsersRepository.dart' as _i19;
...
import 'package:app/src/domain/useCases/categories/CategoriesUseCases.dart'
    as _i11;
import 'package:app/src/domain/useCases/orders/OrdersUseCases.dart' as _i14;
import 'package:app/src/domain/useCases/roles/RolesUseCases.dart' as _i17;
import 'package:app/src/domain/useCases/users/UsersUseCases.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i12.OrdersRepository>(() => appModule.ordersRepository);
    gh.factory<_i13.OrdersService>(() => appModule.ordersService);
    gh.factory<_i14.OrdersUseCases>(() => appModule.ordersUseCases);
    gh.factory<_i15.RolesRepository>(() => appModule.rolesRepository);
    gh.factory<_i16.RolesService>(() => appModule.rolesService);
    gh.factory<_i17.RolesUseCases>(() => appModule.rolesUseCases);
    gh.factory<_i18.SharedPref>(() => appModule.sharedPref);
    gh.factoryAsync<String>(() => appModule.token);
    gh.factory<_i19.UsersRepository>(() => appModule.usersRepository);
    gh.factory<_i20.UsersService>(() => appModule.usersService);
    gh.factory<_i21.UsersUseCases>(() => appModule.usersUseCases);
    return this;
  }
}
