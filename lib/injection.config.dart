...
import 'package:app/src/data/dataSource/local/SharedPref.dart' as _i12;
...
import 'package:app/src/data/dataSource/remote/services/UsersService.dart'
    as _i14;
import 'package:app/src/di/AppModule.dart' as _i16;
...
import 'package:app/src/domain/repositories/RolesRepository.dart' as _i9;
import 'package:app/src/domain/repositories/UsersRepository.dart' as _i13;
...
import 'package:app/src/domain/useCases/roles/RolesUseCases.dart' as _i11;
import 'package:app/src/domain/useCases/users/UsersUseCases.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.RolesRepository>(() => appModule.rolesRepository);
    gh.factory<_i10.RolesService>(() => appModule.rolesService);
    gh.factory<_i11.RolesUseCases>(() => appModule.rolesUseCases);
    gh.factory<_i12.SharedPref>(() => appModule.sharedPref);
    gh.factoryAsync<String>(() => appModule.token);
    gh.factory<_i13.UsersRepository>(() => appModule.usersRepository);
    gh.factory<_i14.UsersService>(() => appModule.usersService);
    gh.factory<_i15.UsersUseCases>(() => appModule.usersUseCases);
    return this;
  }
}
